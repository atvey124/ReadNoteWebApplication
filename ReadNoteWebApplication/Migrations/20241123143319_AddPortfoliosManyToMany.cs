...
{
    /// <inheritdoc />
    public partial class AddPortfoliosManyToMany : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Portfolios", x => new { x.UserId, x.NoteId });
                    table.ForeignKey(
                        name: "FK_Portfolios_Notes_NoteId",
                        column: x => x.NoteId,
